...
from travertino.constants import BOLD, CURSIVE, FANTASY, ITALIC, MESSAGE, MONOSPACE, NORMAL, OBLIQUE, SANS_SERIF, SERIF, SMALL_CAPS, SYSTEM
from travertino.fonts import Font as BaseFont
import toga
from toga.platform import get_platform_factory
SYSTEM_DEFAULT_FONTS = {SYSTEM, MESSAGE, SERIF, SANS_SERIF, CURSIVE,
    FANTASY, MONOSPACE}
...
class Font(BaseFont):
    ...
    def __init__(self, family: str, size: (int | str), *, weight: str=
        NORMAL, style: str=NORMAL, variant: str=NORMAL):
        ...
        """
        super().__init__(family, size, weight=weight, style=style, variant=
            variant)
        self.factory = get_platform_factory()
        self._impl = self.factory.Font(self)

    def __str__(self) ->str:
        size = ('default size' if self.size == SYSTEM_DEFAULT_FONT_SIZE else
            f'{self.size}pt')
    ...
    @staticmethod
    def register(family: str, path: (str | Path), *, weight: str=NORMAL,
        style: str=NORMAL, variant: str=NORMAL) ->None:
    ...
    @staticmethod
    def _registered_font_key(family: str, weight: str, style: str, variant: str
