...
class CountValidator:
    ...
    def __init__(self, count: (int | None), expected_existence_message: str,
        expected_non_existence_message: str, expected_count_message: str,
    ...
    def __call__(self, input_string: str) ->(str | None):
        ...
        if (self.expected_count is not None and actual_count != self.
            expected_count):
...
class LengthBetween(BooleanValidator):
    ...
    def __init__(self, min_length: (int | None), max_length: (int | None),
        error_message: (str | None)=None, allow_empty: bool=True):
        ...
        if (min_length is not None and max_length is not None and 
            ...
            raise ValueError(
                'Minimum length cannot be less than maximum length')
...
class MinLength(LengthBetween):
    ...
    def __init__(self, length: int, error_message: (str | None)=None,
        allow_empty: bool=True):
        ...
        if error_message is None:
            error_message = (
                f'Input is too short (length should be at least {length})')
        super().__init__(min_length=length, max_length=None, error_message=
            error_message, allow_empty=allow_empty)
...
class MaxLength(LengthBetween):
    ...
    def __init__(self, length: int, error_message: (str | None)=None):
        ...
        if error_message is None:
            error_message = (
                f'Input is too long (length should be at most {length})')
        super().__init__(min_length=None, max_length=length, error_message=
            error_message)


class StartsWith(BooleanValidator):

    def __init__(self, substring: str, error_message: (str | None)=None,
        allow_empty: bool=True):
...
class Contains(CountValidator):
    ...
    def __init__(self, substring: str, count: (int | None)=None,
        error_message: (str | None)=None, allow_empty: bool=True):
        ...
        if error_message is not None:
            ...
            expected_non_existence_message = (
                f'Input should not contain {substring!r}')
            expected_count_message = (
                f'Input should contain {substring!r} exactly {count} times')
        super().__init__(count=count, expected_existence_message=
            expected_existence_message, expected_non_existence_message=
            expected_non_existence_message, expected_count_message=
            expected_count_message, allow_empty=allow_empty)
        self.substring = substring
...
class NotContains(Contains):
    ...
    def __init__(self, substring: str, error_message: (str | None)=None):
        ...
        """
        super().__init__(substring, count=0, error_message=error_message)


class MatchRegex(BooleanValidator):

    def __init__(self, regex_string: str, error_message: (str | None)=None,
        allow_empty: bool=True):
...
class ContainsUppercase(CountValidator):
    ...
    def __init__(self, count: (int | None)=None, error_message: (str | None
        )=None, allow_empty: bool=True):
...
class ContainsDigit(CountValidator):
    ...
    def __init__(self, count: (int | None)=None, error_message: (str | None
        ...
        if error_message is not None:
            ...
            expected_count_message = (
                f'Input should contain exactly {count} digits')
        super().__init__(count=count, expected_existence_message=
            expected_existence_message, expected_non_existence_message=
            expected_non_existence_message, expected_count_message=
            expected_count_message, allow_empty=allow_empty)
...
class ContainsSpecial(CountValidator):
    ...
    def count(self, input_string: str) ->int:
        return len([char for char in input_string if not char.isalpha() and
...
class Email(MatchRegex):
    ...
    def __init__(self, error_message: (str | None)=None, allow_empty: bool=True
        ...
        super().__init__(self.EMAIL_REGEX, error_message=error_message,
