...
def rehint_imageview(image: toga.Image, style: StyleT, scale: int=1) ->tuple[
    int, int, float | None]:
...
class ImageView(Widget):
    ...
    def __init__(self, image: (ImageContentT | None)=None, id: (str | None)
        =None, style: (StyleT | None)=None, **kwargs):
