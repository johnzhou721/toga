...
if TYPE_CHECKING:
    ...
    OptionContainerContentT: TypeAlias = tuple[str, Widget] | tuple[str,
        Widget, IconContentT | None] | tuple[str, Widget, IconContentT |
        None, bool] | toga.OptionItem
...
class OptionItem:
    ...
    def __init__(self, text: str, content: Widget, *, icon: (IconContentT |
    ...
    def enabled(self, value: object) ->None:
        ...
        if hasattr(self, '_enabled'):
            ...
            if (not enable and self.index == self._interface._impl.
                get_current_tab_index()):
                raise ValueError(
                    'The currently selected tab cannot be disabled.')
...
class OptionList:
    ...
    def index(self, value: (str | int | OptionItem)) ->int:
        ...
        if isinstance(value, int):
            ...
            try:
                return next(filter(lambda item: item.text == str(value), self)
                    ).index
    ...
    @overload
    def append(self, text_or_item: OptionItem) ->None:
        ...

    @overload
    def append(self, text_or_item: str, content: Widget, *, icon: (
        IconContentT | None)=None, enabled: (bool | None)=True) ->None:
        ...

    def append(self, text_or_item: (str | OptionItem), content: (Widget |
        None)=None, *, icon: (IconContentT | None)=None, enabled: (bool |
        None)=None) ->None:
        ...
        """
        self.insert(len(self), text_or_item, content, icon=icon, enabled=
            enabled)

    @overload
    def insert(self, index: (int | str | OptionItem), text_or_item: OptionItem
        ) ->None:
        ...

    @overload
    def insert(self, index: (int | str | OptionItem), text_or_item: str,
        content: Widget, *, icon: (IconContentT | None)=None, enabled: (
        bool | None)=True) ->None:
        ...

    def insert(self, index: (int | str | OptionItem), text_or_item: (str |
        OptionItem), content: (Widget | None)=None, *, icon: (IconContentT |
        None)=None, enabled: (bool | None)=None) ->None:
        ...
        if isinstance(text_or_item, OptionItem):
            ...
            if icon is not None:
                raise ValueError(
                    'Cannot specify icon if using an OptionItem instance.')
            if enabled is not None:
                raise ValueError(
                    'Cannot specify enabled if using an OptionItem instance.')
            item = text_or_item
        else:
            item = OptionItem(text_or_item, content, icon=icon, enabled=
...
class OptionContainer(Widget):
    ...
    def __init__(self, id: (str | None)=None, style: (StyleT | None)=None,
        content: (Iterable[OptionContainerContentT] | None)=None, on_select:
        (toga.widgets.optioncontainer.OnSelectHandler | None)=None, **kwargs):
            ...
            for item in content:
                if isinstance(item, OptionItem):
                    ...
                    if len(item) == 2:
                        ...
                        raise ValueError(
                            'Content items must be an OptionItem instance, or tuples of (title, widget), (title, widget, icon), or (title, widget, icon, enabled)'
                            )
                    self.content.append(text, widget, enabled=enabled, icon
                        =icon)
    ...
    @on_select.setter
    def on_select(self, handler: toga.widgets.optioncontainer.OnSelectHandler
        ) ->None:
