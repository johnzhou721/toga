...
class TextInput(Widget):
    ...
    def __init__(self, id: (str | None)=None, style: (StyleT | None)=None,
        ...
        None)=None, on_change: (toga.widgets.textinput.OnChangeHandler |
        None)=None, on_confirm: (OnConfirmHandler | None)=None,
        on_gain_focus: (OnGainFocusHandler | None)=None, on_lose_focus: (
        OnLoseFocusHandler | None)=None, validators: (Iterable[Callable[[
    ...
    @on_change.setter
    def on_change(self, handler: toga.widgets.textinput.OnChangeHandler
        ) ->None:
    ...
    @validators.setter
    def validators(self, validators: (Iterable[Callable[[str], bool]] | None)
        ) ->None:
